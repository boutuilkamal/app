          ...
          {sidebarOpen ? (
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900 rounded-lg transition"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
            ...
            <button
              onClick={handleLogout}
              className="w-full flex justify-center p-2 text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900 rounded-lg transition"
            >
              <svg
                className="w-6 h-6"
                fill="none"
