...
export default function RegisterPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-md">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">{t('register')}</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="text-sm text-gray-700 dark:text-gray-200">{t('firstName')}</label>
            <input
              {...register('firstName')}
          ...
          <div>
            <label className="text-sm text-gray-700 dark:text-gray-200">{t('lastName')}</label>
            <input
              {...register('lastName')}
              className="mt-1 w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-3 py-2"
              type="text"
        ...
        <div>
          <label className="text-sm text-gray-700 dark:text-gray-200">{t('role')}</label>
          <select
            {...register('role')}
            className="mt-1 w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-3 py-2"
          >
      ...
      <div className="mt-6 text-sm text-gray-600 dark:text-gray-300">
        <Link className="text-blue-600 dark:text-blue-400 hover:underline" href="/auth/login">
          {t('login')}
        </Link>
      </div>
    </div>
